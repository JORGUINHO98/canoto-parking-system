...
@section('content')
    <div class="mb-4">
        ...
        <h1 class="h3 park-display mt-2 mb-1">Nuevo vehículo</h1>
    </div>

    <div class="card park-card">
        <div class="card-header">Datos del vehículo</div>
        <div class="card-body">
            <form action="{{ route('parking.vehiculos.store') }}" method="post">
                @csrf
                @include('catalog.vehiculos._form', ['clientes' => $clientes])
